class App extends React.Component {
  ...
  handleClick() {
    ...
    // If click=true, while row=active
    ...
    // Update active row index per click
    this.updateActiveRow();
  }

  updateActiveRow() {
    // If the active section != row
...
// Render the app
// May face bugs in state-hooks and promises
